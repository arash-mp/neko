...
Nxll =  6;      Rxll = 1.15;    // Progression ratio towards left (elements clustered on left side of Nxll box if Rxlr<0)

Nyc  = Nxc;     Ryc  = 1.0;    // Progression ratio towards top (elements clustered on top side of Nyc box if Ryc<0)
Nytb =  6;       Rytb = 1.0;   // Progression ratio towards bottom (elements clustered on bottom side of Nytb box if Rytb<0)
Nytp =  6;       Rytp = 1.0;   // Progression ratio towards bottom (elements clustered on bottom side of Nytp box if Rytp<0)

Nb   =  12;      Rb   = 0.7;    // Progression ratio towards center (elements clustered on the central part side of Nb box if Rb<0)
